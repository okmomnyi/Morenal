 ...
 * Sign In Page
 * 
 * This page provides sign-in functionality for both admin and customer users.
 */
...
import { useSignIn, useGoogleSignIn } from "@/hooks/useFirebaseAuth";
        ...
        <div className="p-8 bg-white shadow-xl dark:bg-gray-dark rounded-2xl">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  id="remember"
                  type="checkbox"
                  className="w-4 h-4 border-gray-300 rounded text-brand-500 focus:ring-brand-500"
                />
                <label
                  htmlFor="remember"
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 text-gray-500 bg-white dark:bg-gray-dark dark:text-gray-400">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <button
            ...
            className="flex items-center justify-center w-full px-6 py-3 transition border border-gray-300 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
